    ...
    <div className='fixed inset-0 flex items-center justify-center z-50'>
      ...
      <div className='relative bg-white rounded-lg shadow-lg p-6 w-96'>
        ...
        <div className='flex justify-end space-x-2'>
          <button
            className='bg-transparent text-blue-500 border-2 border-blue-500 uppercase transition-all duration-200 font-bold px-4 py-2 rounded hover:bg-blue-500 hover:text-white focus:border-blue-700'

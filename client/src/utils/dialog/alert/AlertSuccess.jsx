...
import alertSuccess from '@/assets/dialog/alertSuccess.svg';
    ...
    <div className='fixed inset-0 mt-10 flex justify-center z-50'>
      ...
      <div className='relative shadow-dialog bg-white rounded-lg p-6 h-48 w-[550px] '>
        <div className='flex items-center'>
          <img className='w-11 mr-3' src={alertSuccess} alt='alertSuccess' />
        ...
        <div className='flex justify-end space-x-2'>
          <button
            className='absolute bottom-4 right-4 bg-mint text-white text-sm transition-all duration-200 font-700 px-8 h-8 rounded-lg hover:bg-mint_hover'
            onClick={onClose}
            autoFocus>
            확인
          </button>

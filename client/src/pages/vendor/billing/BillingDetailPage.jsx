...
const BillingDetailPage = () => {
  ...
  const handleEditSave = async () => {
    try {
      ...
      onAlert({
        msg: '청구가 수정되었습니다. 수정된 내용을 확인해주세요!',
        type: 'success',
        title: '청구 수정성공',
      });
      setIsEditing(false);
  ...
  const handleSend = async () => {
    try {
      ...
      onAlert({ msg: '청구서가 발송되었습니다.', type: 'default', title: '청구서 발송' });
      fetchBillingDetail();
    } catch (err) {
  ...
  const handleCancelSend = async () => {
    ...
    try {
      ...
      onAlert({ msg: '청구서 발송이 취소되었습니다.', type: 'default', title: '청구서 발송취소' });
      fetchBillingDetail();
    } catch (err) {
  ...
  const handlePay = async () => {
    ...
    try {
      ...
      onAlert({ msg: '청구가 결제되었습니다!', type: 'default', title: '실시간 결제' });
      fetchBillingDetail();
    } catch (err) {
  ...
  const handleCancelPay = async () => {
    ...
    try {
      ...
      onAlert({ msg: '결제가 취소되었습니다!', type: 'default', title: '결제취소' });
      fetchBillingDetail();
    } catch (err) {

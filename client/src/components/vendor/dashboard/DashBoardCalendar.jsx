...
const getEventColor = (status) => {
  switch(status) {
    case 'NON_PAID': return '#FCA5A5';
    case 'WAITING_PAYMENT': return '#FCD34D';
    case 'PAID': return '#6EE7B7';
    case 'CREATED': return '#93C5FD';
  ...
  return (
    <div className="bg-white p-3 rounded-lg shadow-lg border border-gray-200 text-sm">
      <div className="grid grid-cols-2 gap-2">
        <p><span className="font-semibold text-green-600">완납:</span> {statusCounts.PAID || 0}건</p>
        <p><span className="font-semibold text-yellow-600">수납 대기중:</span> {statusCounts.WAITING_PAYMENT || 0}건</p>
        <p><span className="font-semibold text-red-600">미납:</span> {statusCounts.NON_PAID || 0}건</p>
        <p><span className="font-semibold text-blue-600">생성:</span> {statusCounts.CREATED || 0}건</p>
      </div>
    </div>
  );
};

      ...
      <table className="w-full mb-3">
        ...
        <tbody>
          {contractList.map((contract) => (
            ...
            >
              <td className="border-b border-ipt_border p-2 text-text_black">{contract.memberName}</td>
              <td className="border-b border-ipt_border p-2 text-text_black">{`${contract.contractDay}일`}</td>
              <td className="border-b border-ipt_border p-2 text-text_black">{formatProducts(contract.contractProducts)}</td>
